...
namespace BoardingGamesManager.Controllers
{
    public class GamesController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Name,MinDuration,OurDuration,MaxDuration,MinAge,MinPlayer,BestNumberPlayer,Maxplayer,Editeur")] Game game)
        {
            if (id != game.ID)
            {
                return NotFound();
